...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-10-2020 a las 21:41:55
...
--
-- Estructura de tabla para la tabla `siigo`
--

CREATE TABLE `siigo` (
  `id_usuario_sigo` varchar(11) NOT NULL,
  `nombre_usurio` varchar(25) NOT NULL,
  `clave_usuario_sigo` varchar(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `siigo`
--

INSERT INTO `siigo` (`id_usuario_sigo`, `nombre_usurio`, `clave_usuario_sigo`) VALUES
('siigo', 'siigo', 'siigo');
...
CREATE TABLE `tienda` (
  ...
  `id_siigo` varchar(11) DEFAULT NULL,
  `id_sucursal` varchar(11) NOT NULL,
...
--
-- Indices de la tabla `siigo`
--
ALTER TABLE `siigo`
  ADD PRIMARY KEY (`id_usuario_sigo`);
...
ALTER TABLE `sucursal_usuario`
  ...
  ADD CONSTRAINT `sucursal_usuario_ibfk_3` FOREIGN KEY (`id_sucursal`) REFERENCES `sucursal` (`id_sucursal`);
...
ALTER TABLE `tienda`
  ...
  ADD CONSTRAINT `tienda_ibfk_2` FOREIGN KEY (`id_siigo`) REFERENCES `siigo` (`id_usuario_sigo`);
